...
export class EventNormalizer {
   ...
   * 标准化事件基础字段
   */
  static normalizeBase(e: EventLike | null | undefined, options: NormalizeOptions = {}): EventLike | null | undefined {
    if (!e) return e;
   ...
   * 标准化消息字段
   */
  static normalizeMessage(e: EventLike | null | undefined): EventLike | null | undefined {
    if (!e) return e;
   ...
   * 标准化群组相关字段
   */
  static normalizeGroup(e: EventLike | null | undefined): EventLike | null | undefined {
    if (!e) return e;
   ...
   * 完整标准化（组合所有通用方法）
   */
  static normalize(e: EventLike | null | undefined, options: NormalizeOptions = {}): EventLike | null | undefined {
    if (!e) return e;
   ...
   */
  static normalizeOneBot(e: EventLike | null | undefined, _eventType?: string): EventLike | null | undefined {
    if (!e) return e;
    e.tasker = 'onebot';
    e.isOneBot = true;
   ...
   */
  static normalizeDevice(e: EventLike | null | undefined): EventLike | null | undefined {
    if (!e) return e;
    e.tasker = 'device';
    e.isDevice = true;
    e.isGroup = false;
   ...
   */
  static normalizeStdin(e: EventLike | null | undefined): EventLike | null | undefined {
    if (!e) return e;
    e.tasker = 'stdin';
    e.isStdin = true;
  ...
  static normalizeOneBotMessage(e: EventLike | null | undefined): EventLike | null | undefined {
